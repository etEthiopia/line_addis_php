        ...
        <div class="col-lg-4 col-md-5">
            <div class="form-container">
                <div class="media-container-column" data-form-type="formoid">
                    <!---Formbuilder Form--->
                    <form action="<?php echo URLROOT; ?>/agents/login" method="POST" class="mbr-form form-with-styler"
                        ...
                        <div class="dragArea row">
                            ...
                            <p class="mbr-text pb-3 mbr-fonts-style display-9 align-center" style="color: white;">If You Forgot Your Password, Please Send an Email to <strong>hello@lineaddis.com</strong></p>
                        </div>
