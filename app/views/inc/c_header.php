    ...
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/assets/datatables/data-tables.bootstrap4.min.css">
        ...
        <nav
                ...
                <div class="navbar-brand">
                    <span class="navbar-logo">
                        <a href="<?php echo URLROOT; ?>/pages/index/">
                            <img src="<?php echo URLROOT; ?>/assets/images/line-addis-bw-logo-122x54.png" alt="LINE ADDIS" title=""
                                style="height: 3.8rem;">
                        </a>
                    </span>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
                    <li class="nav-item"><a class="nav-link link text-primary display-4" href="<?php echo URLROOT; ?>/controls/dashboard">
                            Dashboard</a></li>
                    <li class="nav-item"><a class="nav-link link text-primary display-4" href="<?php echo URLROOT; ?>/controls/students">
                            Students</a></li>
                    <li class="nav-item"><a class="nav-link link text-primary display-4" href="<?php echo URLROOT; ?>/controls/agents">
                            Agents</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link link text-primary display-4"
                            href="<?php echo URLROOT; ?>/controls/logout">Log Out&nbsp;&nbsp;</a></li>
