...
<script>
    ...
    function clearcheck() {
        var specify = document.getElementById('non_specified').checked;
        if (specify) {
            var areachoices = document.getElementsByClassName("areachoices");
            for (let item of areachoices) {
                item.checked = false;
            }
        }
    }

    function cancelspecification(id) {
        if (document.getElementById(id).checked) {
            document.getElementById('non_specified').checked = false;
        }
    }
</script>
...
<script type="text/javascript">
    ...
    (function () {
        ...
        s1.async = true;
        s1.src = 'https://embed.tawk.to/5f2533eb4f3c7f1c910d9d4a/default';
        s1.charset = 'UTF-8';
