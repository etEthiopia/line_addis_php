        ...
        <div class="col-lg-4 col-md-5">
            <div class="form-container">
                <div class="media-container-column" data-form-type="formoid">
                    <!---Formbuilder Form--->
                    <form action="<?php echo URLROOT; ?>/controls/login" method="POST" class="mbr-form form-with-styler"
                        ...
                        <div class="dragArea row">
                            ...
                            <div class="col-md-12 form-group " data-for="emp_id">
                                <input type="text" maxlength="9" name="username" placeholder="Id" data-form-field="Emp Id"
