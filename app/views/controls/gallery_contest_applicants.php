...
<head>
    ...
    <title>Contest Applicants</title>
                        ...
                        <div class="media-content">
                            <div class="mbr-section-text mb-0 mbr-fonts-style display-1 align-center">
                                ...
                                <p style="display:inline;" class="mbr-text mb-0 mbr-fonts-style display-2"
                                    id="profile_emp_id">Applicants In Total</p>&nbsp;
        ...
        <div class="container container-table">
            ...
            <div class="table-wrapper">
                ...
                <div class="container scroll">
                    <table class="table table-striped table-bordered" id="my_contest_table" cellspacing="0"
                        ...
                        <tbody>
                            <?php foreach($data as $applicant) : ?>
                            <tr>
                                <td class="body-item mbr-fonts-style display-7">
                                <a class="link display-7 normal-link" href="<?php echo URLROOT; ?>/controls/openGalleryContestApplicant/<?php echo $applicant->id ?>">
                                <?php if(strlen($applicant->name) > 20) : ?>
                                    <?php echo substr($applicant->name, 0, 20).'...'?>
                                <?php else : ?>
                                ...
                                <td class="body-item mbr-fonts-style display-7">
                                    <?php echo substr($applicant->created_at, 0, 10);?>
                                </td>
