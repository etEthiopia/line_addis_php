            ...
            <div class="card p-3 col-12 col-md-6">
                <div class="card-wrapper media-container-row media-container-row">
                    <div class="card-box">
                        ...
                        <p class="mbr-text mbr-fonts-style display-2"><a class=" link text-primary" href="<?php echo URLROOT; ?>/employees/agent_detail/<?php echo $data['student']->agent; ?>" ><?php echo $data['student']->agent_name?></a>
                    </p>
                    </div>
                </div>
            </div>
