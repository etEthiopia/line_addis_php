        ...
        <div class="col-lg-4 col-md-5">
            <div class="form-container">
                <div class="media-container-column" data-form-type="formoid">
                    <!---Formbuilder Form--->
                    <form action="<?php echo URLROOT; ?>/employees/register" method="POST" class="mbr-form form-with-styler"
                        ...
                        <div class="dragArea row">
                            ...
                            <div class="col-md-12 input-group-btn">
                                <button type="submit" class="btn btn-secondary btn-form display-4">REGISTER</button>
                            </div>
                        </div>
                    </form>
                    <!---Formbuilder Form--->
